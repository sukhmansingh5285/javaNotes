// sort() method of collections class can sort the objects of those classes which are
// implementing Comparable interface by default.
...
public class ListSortComparable {
    ...
    public static void main(String a[]){
        ...
        Collections.sort(list); //now it will sort based on the compareTo method, hence by salary
